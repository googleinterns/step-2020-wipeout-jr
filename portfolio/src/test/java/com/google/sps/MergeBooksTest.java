...
public final class MergeBooksTest {
  ...
  private static Book newBook(String title, String category, String author, String genre,
      String language, int pageCount, String isbn, ArrayList<String> reviews) {
    ArrayList<String> authors = new ArrayList<String>();
    authors.add(author);
    ArrayList<String> categories = new ArrayList<String>();
  ...
  public void simpleMerge() {
    ...
    Book mockCSVBook = newReviewsBook("A Court of Wings and Ruin", "Fantasy",
  ...
  public void parseTwoDifferentTitles() throws Exception {
    Book originalBook =
        newBook("A Court of Wings and Ruin", "Fiction", "Sarah J. Maas", "Fantasy", "en", 432, "",
            reviewsMaker("It was good.", "It was pretty good.", "It was heart-wrenching."));
    Book diffTitleBook =
        newBook("Monkey Goes to Big City", "Fiction", "Sarah J. Maas", "Fantasy", "en", 432, "",
            reviewsMaker("It was good.", "It was pretty good.", "It was heart-wrenching."));
