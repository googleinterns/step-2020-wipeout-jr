...
public final class BookDaoTest {
  ...
  private static Book newBook(String title, String category, String author, String genre,
      String language, int pageCount, String isbn) {
    ArrayList<String> authors = new ArrayList<String>();
    authors.add(author);
    ArrayList<String> categories = new ArrayList<String>();
  ...
  public void validateBookNullIsbn() {
    Book nullIsbn =
        newBook("A Court of Wings and Ruin", "Fiction", "Sarah Maas", "Fantasy", "en", 34, null);
  ...
  public void validateBookEmptyIsbn() {
    Book emptyIsbn =
        newBook("A Court of Wings and Ruin", "Fiction", "Sarah Maas", "Fantasy", "en", 34, "");
  ...
  public void validateBookShortIsbn() {
    Book shortIsbn =
        newBook("A Court of Wings and Ruin", "Fiction", "Sarah Maas", "Fantasy", "en", 34, "12345");
    BookDao.create(shortIsbn);
  }

  @Test(expected = IllegalArgumentException.class)
  public void validateBookLongIsbn() {
    Book longIsbn = newBook("A Court of Wings and Ruin", "Fiction", "Sarah Maas", "Fantasy", "en",
        34, "1234543243792349374074");
  ...
  public void updateBook() {
    ...
    Book original = newBook(
        "A Court of Wings and Ruin", "Fiction", "Sarah Maas", "Fantasy", "en", 34, "9781619634497");
    BookDao.create(original);

    Book updatedBook = newBook("A Court of Ruin and Wings", "Historical", "Sarah Maas", "Biography",
        "en", 34, "9781619634497");
