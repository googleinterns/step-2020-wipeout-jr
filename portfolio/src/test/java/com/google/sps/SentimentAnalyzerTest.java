...
@Ignore // Tests pass but only work one-at-a-time locally due to API Permissions
...
public class SentimentAnalyzerTest {
  ...
  public void testEntities() throws IOException {
    Set<String> entities = analyzer.getEntities(TECH_SENTENCE);
    Assert.assertTrue(entities.contains("Pixelbook"));
    Assert.assertTrue(entities.contains("Chromebook"));
    Assert.assertTrue(entities.contains("panel"));
